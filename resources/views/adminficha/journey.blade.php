...
<a style="margin:0px auto; display:block" class="button has-background-grey has-text-centered has-text-white mb-4" href="{{route('adminficha.index')}}">Volver a Fichas</a>
@endsection
